...
typedef enum
{ 
	START, INASSIGN, INCOMMENT, ENDCOMMENT, INNUM, INID, INLESSTHAN, INHYPHEN, DONE
} StateType;
...
{ 
	...
	// Single symbols
	PLUS, MINUS, MUL, DIV, OPEN_PAREN, CLOSE_PAREN, OPEN_CURLY_BRACE, CLOSE_CURLY_BRACE, OPEN_SQUARE_BRACE, CLOSE_SQUARE_BRACE, COLON, SEMICOLON, 
	// Double symbols
	ASSIGN, EQUIVALENCE, TILDE, LESS_THAN_EQUAL, LESS_THAN, NOT, DOT, AT_RATE_OF, 
	// Key words
